const testimonials = [
    {
        ...
        image : "https://images.pexels.com/photos/1133742/pexels-photo-1133742.jpeg",
        content : 
    ...
    {
        name : "Marcus Radriguez",
        role : "Tech Lead",
        image : "https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg",
        content : 
          "The automated testing and debbugging features are game-changers",
    },
    {
        name : "Emily Watson",
        role : "CTO",
        image : "https://images.pexels.com/photos/7893740/pexels-photo-7893740.jpeg",
        content : 
              "Our development velocity increased by 300% since adopting this platform.",
    }
]
     ...
     <section id="testimonials" 
         className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative">
          ...
          <div className="max-w-7xl mx-auto text-gray-100">
            ...
            {/* leftside section = header */}
             <div className="lg:w-1/2  w-full text-center lg:text-left">
                <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
                    What developers saying about us.
                </h2>
              ...
              <div className="space-y-6 sm:space-y-8">
                {testimonials.map((testimonial, testimonialsKey) => (
                   <div key={testimonialsKey} className="bg-slate-900/50 p-4 sm:p-6 backdrop-blur border border-slate-800 rounded-xl sm:rounded-2xl"> 
